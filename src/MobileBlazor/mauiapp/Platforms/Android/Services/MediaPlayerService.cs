...
/* Cambio no fusionado mediante combinación del proyecto 'NetPodsMauiBlazor (net6.0-windows10.0.19041)'
Antes:
using Microsoft.Maui.Platform;
Después:
using Microsoft.Maui.Platform;
using NetPodsMauiBlazor;
using NetPodsMauiBlazor.Platforms;
